...
Journal Reviewing \\
\emph{JAIR (2012), TOIS (2012), TKDE (2014), JMLR MLOSS (2013), TACL (2013,2014), Computational Linguistics (2013)}

Program Committee \\
\emph{EMNLP (2010,2011,2012,2013,2014), ACL (2012,2013), NAACL-HLT (2012,2013), CoNLL (2013,2014), AAAI (2012,2015), EACL (2012,2014), Coling (2014), ICWSM (2012), LREC (2012), IJCAI (2011), *SEM (2013), WWW (2014), CIKM (2014)}
