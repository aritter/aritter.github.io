...
``Information Extraction for the Social Web'' \\
Machine Learning Seminar, Purdue University, December 2015 \\
Statistics Department, Ohio State University, October 2015 \\
School of Computer Science, Carnegie Mellon University, April 2015 \\
CLIP, University of Maryland, March 2015 \\
...
Computer Science Departmental Colloquium, University of Pittsburgh, January 2014 \\
...
Organizer \\
\emph{Sentiment Analysis in Twitter Shared Task (SemEval 2013,2014,2015,2016)}

\emph{Named Entity Recognition in Twitter Shared Task (WNUT 2015)}

\emph{ACL Workshop on Noisy User-Generated Text (WNUT 2015)}



Session Chair \\
\emph{EMNLP 2012 (Social Media)}, \emph{NAACL 2013 (Social Media)}, \emph{ACL 2014 (Social Media)}, \emph{ACL 2015 (Social Media)}, \emph{AAAI 2015 (Natural Language Processing)}, \emph{WWW 2015 (Social Media Linguistics)}

Journal Reviewing \\
\emph{ACM Computing Surveys (2014), TACL (2013,2014,2015), Computational Linguistics (2013,2015), JAIR (2012), TOIS (2012), TKDE (2014), JMLR MLOSS (2013), Journal of Natural Language Engineering (2014)}

Program Committee \\
\emph{EMNLP (2010,2011,2012,2013,2014,2015), ACL (2012,2013,2015), NAACL-HLT (2012,2013,2016), CoNLL (2013,2014), AAAI (2012,2015), EACL (2012,2014), Coling (2014), ICWSM (2012), LREC (2012), IJCAI (2011), *SEM (2013), WWW (2014,2015,2016), CIKM (2014)}
